...
// let GlobalResearchData = null;


// fetchData('/static/db/research.json');
...
//     let CategorySelector = document.getElementById('PaperShowcase-module--CategorySelector');

//     for(let i = 0; i < data['Fields'].length; i++) {
//         button = document.createElement('button');
//         button.setAttribute('class', 'PaperShowcase-module--CategorySelector--Button');
